            ...
            <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto;">
                ...
                <div style="padding: 8px 10px 20px 30px;">
                    ...
                    <div style="padding-left: 15px;">
                        <p style="font-size: 15px;">Welcome to Esports Vantage! We're glad to have you.</p>
                        <p style="font-size: 15px;">Please click the button below to verify your Esports Vantage account:</p>
                        <a href="{verify_url}" 
                    ...
                    <p style="text-align: left;">- Esports Vantage Dev Team</p>
                </div>
                {get_email_footer()}
            </div>
        </div>
    ...
    def verify_email(token: str):
        ...
        try:
            ...
            if user:
                ...
                flash('Email is successfully verified, welcome to Esports Vantage! You can now log in.', 'success')
                    ...
                    <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto;">
                        ...
                        <div style="padding: 8px 10px 20px 30px;">
                            ...
                            <div style="padding-left: 15px;">
                                ...
                                <p style="font-size: 15px;">Please log into Esports Vantage and click the <strong>"Record Playoffs Results"</strong> button in your dashboard to get started.</p>
...
def send_password_reset_email(email: str, token: str, user_firstname: str) -> bool:
    ...
    try:
        ...
        msg = Message('Reset Your Esports Vantage Password', recipients=[email])
        msg.html = f'''
            <div style="background-color: #f4f4f4; width: 100%; margin: 0; padding: 10px 0; font-family: 'Inter', sans-serif;">
                <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto;">
                    <div style="margin: 0; padding: 0;">
                    ...
                    <div style="padding: 8px 10px 20px 30px;">
                        ...
                        <p style="text-align: left; font-weight: bold;">Hello, {user_firstname}!</p>
                        <div style="padding-left: 15px;">
                            <p style="font-size: 15px;">We received a request to reset your Esports Vantage password.</p>
...
def get_email_footer() -> str:
    return f'''
        ...
        color: #aaaaaa; font-family: 'Inter', sans-serif;">
            ...
            <p style="margin: 0;">©{datetime.now().year} Esports Vantage. All rights reserved.</p>
        </div>
    '''
